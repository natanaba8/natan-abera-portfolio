...
// My social links and (icon) has to be one of github, linkedin, twitter, email
export const socialLinks = [
  { name: 'GitHub', url: '#', icon: 'github' },
  { name: 'LinkedIn', url: '#', icon: 'linkedin' },
  { name: 'Twitter', url: '#', icon: 'twitter' },
  { name: 'Email', url: 'mailto:natanaba8@gmail.com', icon: 'email' },
]
...
// The About section and Each string in the list becomes its own paragraph.
...
/* the Projects section "category" is used by the filter buttons, so keep it as one of
